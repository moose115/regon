...
var Client = /** @class */ (function () {
    function Client(_a) {
        ...
        this._soapClientPromise = this.createClient();
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.soapClientPromise];
                    case 1:
                        client = _a.sent();
                        client.clearSoapHeaders();
                        this.addAction(client, constants_1.ACTION_ZALOGUJ);
    ...
    Client.prototype.addAction = function (client, action) {
        client.addSoapHeader({
            To: this._service,
            Action: constants_1.ACTION + action
        }, '', 'wsa', 'http://www.w3.org/2005/08/addressing');
    };
    Object.defineProperty(Client.prototype, "soapClientPromise", {
        get: function () {
